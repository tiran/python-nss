...
def main(argv):
    ...
    nss_error_extension = \
        Extension('nss.error',
                  ...
                  depends            = ['py_2_3_compat.h', 'src/py_nspr_common.h', 'src/py_nspr_error.h',
    ...
    nss_io_extension = \
        Extension('nss.io',
                  ...
                  include_dirs       = [nss_include_dir, nspr_include_dir],
                  depends            = ['py_2_3_compat.h', 'src/py_nspr_common.h', 'src/py_nspr_error.h', 'src/py_nspr_io.h'],
                  libraries          = ['nspr4'],
                  extra_compile_args = extra_compile_args,
                  )
    ...
    nss_nss_extension = \
        Extension('nss.nss',
                  ...
                  depends            = ['py_2_3_compat.h', 'src/py_nspr_common.h', 'src/py_nspr_error.h', 'src/py_nss.h'],
